...
<Layout>
  <div class="bg-muted border-b">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8 border-l border-r border-dashed pt-20 pb-12">
      ...
      <h1 class="text-4xl tracking-tighter text-balance max-lg:font-medium max-sm:px-4 sm:text-5xl lg:text-6xl">New Blog Post</h1>
  ...
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8 py-12 border-l border-r border-dashed">
    <Card.Root>
      <Card.Header>
        ...
        <Card.Description>Fill in information for your new blog post. Supports Markdown formatting.</Card.Description>
      </Card.Header>
